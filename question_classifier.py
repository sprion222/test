...
class Questionclassifier:
    def __init__(self):
        ...
        self.plant_path="./web_crawler/new_data/plant.txt" #streamlit相对路径
        
        #别名需要回查到植物实体,要单独处理
        self.diff_name_path="./web_crawler/new_data/different_name.txt"

        self.color_path="./web_crawler/new_data/color.txt"
        self.category_path="./web_crawler/new_data/category.txt"
        self.taste_path="./web_crawler/new_data/taste.txt"
        self.shape_path="./web_crawler/new_data/shape.txt"
        self.light_path="./web_crawler/new_data/light.txt"
        self.session_path="./web_crawler/new_data/session.txt"
        self.level_path="./web_crawler/new_data/level.txt"
        self.temperature_path="./web_crawler/new_data/temperature.txt"
        self.ph_path="./web_crawler/new_data/ph.txt"
